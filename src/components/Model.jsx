...
import { Plus, Layers2, Pencil, X } from "lucide-react";
                    ...
                    <div className="flex items-center justify-between p-5 md:p-6 border-b border-gray-100 rounded-t-xl">
                        <h3 className="text-xl font-semibold text-gray-800">
                         ...
                         <button 
                            type="button"
                            onClick={onClose}
                            className="text-gray-500 bg-gray-50 hover:bg-gray-100 hover:text-gray-700 rounded-lg text-sm w-9 h-9 flex items-center justify-center transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:blue-500 focus:ring-offset-2" >
                                {/* You would usually put an X icon here */}
